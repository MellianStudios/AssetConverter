local mod = Solution.Util.CreateModuleTable("AssetConverter-App", { "fileformat", "base", "meta", "enkits", "casc", "cuttlefish", "jolt", "tracyprofiler", "recastnavigation-recast", "recastnavigation-detour" })
